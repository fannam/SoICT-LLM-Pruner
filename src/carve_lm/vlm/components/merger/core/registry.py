...
ESTIMATOR_REGISTRY: Registry[type] = Registry("merger estimator")
PRUNER_REGISTRY: Registry[type] = Registry("merger pruner")
PRUNING_STRATEGY_REGISTRY: Registry[type] = Registry("merger pruning strategy")
