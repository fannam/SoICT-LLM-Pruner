...
ESTIMATOR_REGISTRY: Registry[type] = Registry("vision estimator")
PRUNER_REGISTRY: Registry[type] = Registry("vision pruner")
PRUNING_STRATEGY_REGISTRY: Registry[type] = Registry("vision pruning strategy")
